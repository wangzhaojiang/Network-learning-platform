    ...
    <section class="center-grid clearfix">
        ...
        <section class="page-content">
            ...
            <section class="followed-page">
				...
				<{section name = n loop = $user_fans }>
                    <div class="user-relation-page-info  clearfix">
                        <div class="user-relation-button">
							<{if $user_fans[n].relation == 0}>
                            <input data="<{$user_fans[n].uid}>" type="button" value="关注" class=" btn-green relat-btn" />                      
							<{else}>
                            <input data="<{$user_fans[n].uid}>" type="button" value="取消关注" class=" btn-green relat-btn" />                      
							<{/if}>
                        </div>
                        <div class="user-relation-logo-display">
                            <a href="#">
                                <img src="<{$user_fans[n].logo}>">
                            </a>
                        </div>
                        <div class="user-relation-header">
                            <a href="#"><{$user_fans[n].name}></a>
